...
export default function Changelog() {
    return (
        <div className="w-full text-center max-w-xl px-2 mx-auto my-16 text-neutral-700">
            ...
            <div className="prose prose-neutral prose-headings:font-bold prose-headings:font-display prose-headings:text-black prose-a:text-primary-400 prose-a:underline marker:text-inherit prose-li:text-left">
                <h1>Ченджлог</h1>
                
                <div className="bg-amber-50 rounded-2xl p-6 my-8 text-left">
                    <h2 className="text-amber-700 mb-4">Версия 0.2.0 — Закрытый тест</h2>
                    <p className="text-neutral-700">
                        В настоящее время идёт закрытое тестирование версии 0.2.0.
                    </p>
                </div>

                <div className="bg-amber-100 rounded-2xl p-6 my-8 text-left">
                    <h2 className="text-amber-800 mb-4">Версия 0.3.0 — Скоро</h2>
                    <p className="text-neutral-700">
                ...
                <div className="bg-red-50 rounded-2xl p-6 my-8 text-left border-2 border-red-200">
                    <h2 className="text-red-700 mb-4">Известные проблемы (DevTools)</h2>
                    
                    <h3 className="text-red-600 text-lg font-bold mt-4 mb-2">Функции без логики (10 шт)</h3>
                    ...
                    <h3 className="text-red-600 text-lg font-bold mt-4 mb-2">Частичная работа (5 шт)</h3>
                    <ul className="text-neutral-700 text-sm space-y-1">
                    ...
                    <h3 className="text-red-600 text-lg font-bold mt-4 mb-2">UI/UX проблемы (6 шт)</h3>
                    <ul className="text-neutral-700 text-sm space-y-1">
                    ...
                    <h3 className="text-red-600 text-lg font-bold mt-4 mb-2">Критические краши (3 шт)</h3>
                    <ul className="text-neutral-700 text-sm space-y-1">
                    ...
                    <p className="text-sm text-neutral-500 mt-4 pt-4 border-t border-red-200">Всего: 24 бага, из них 3 потенциальных краша</p>
                </div>
            </div>
        </div>
    )
